...
@interface PPSlovakiaIdViewResult : PPIdViewResult

// ID
@property (nonatomic) NSString *idNumber;
@property (nonatomic) NSString *issuingAuthority;
@property (nonatomic) NSString *specialRemarks;
...
@property (nonatomic) NSString *surnameAtBirth;
...
@property (nonatomic, readonly) NSString *specialRemarksKey;
...
@property (nonatomic, readonly) NSString *surnameAtBirthKey;
